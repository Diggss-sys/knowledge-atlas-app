...
- Old-repo prior art: `1michaelbongiorno/cogs160track3v2` → `wizard/lighting_control_surface.md`, `viewer/index.html` (GI probe, sun/time-of-day model, window fill, glass shadows)
