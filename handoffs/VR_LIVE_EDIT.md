...
1. **F0 — Boot + audit.** Boot per [UNITY_GENERATOR.md](UNITY_GENERATOR.md) G0. Audit the auto-created HDRP asset: enable SSAO, SSGI (quality Medium), soft shadows, ACES tonemapping, physically-based exposure; document every setting you change in `unity/ASSETS.md`. *DoD: before/after screenshots of the dining room committed with the PR.*
